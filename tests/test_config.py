...
def test_load_json_returns_data(tmp_path):
    from bot_setup.config import load_json
...
def test_save_then_load_round_trip(tmp_path):
    from bot_setup.config import save_json, load_json
...
def test_needs_setup_returns_false_when_all_keys_present():
    from bot_setup.config import needs_setup, REQUIRED_KEYS
...
def test_fill_defaults_adds_missing_keys():
    from bot_setup.config import fill_defaults, REQUIRED_KEYS
...
def test_fill_defaults_does_not_overwrite_existing():
    from bot_setup.config import fill_defaults
...
def test_get_tournament_end_men_from_config():
    from bot_setup.config import get_tournament_end
